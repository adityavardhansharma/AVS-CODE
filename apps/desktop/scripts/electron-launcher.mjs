// This file mostly exists because we want dev mode to say "AVS Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "AVS Code (Dev)" : "AVS Code (Alpha)";
