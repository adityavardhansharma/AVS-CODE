...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly refreshCodexUsage: RpcUnaryMethod<typeof WS_METHODS.serverRefreshCodexUsage>;
...
export function createWsRpcClient(transport: WsTransport): WsRpcClient {
  return {
    ...
    server: {
      ...
      refreshCodexUsage: (input) =>
        transport.request((client) => client[WS_METHODS.serverRefreshCodexUsage](input)),
