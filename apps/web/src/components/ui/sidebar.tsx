  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-[left,right,width] md:flex",
            side === "left"
  ...
  return (
    <main
      className={cn(
        ...
        "md:transition-[margin,border-radius,box-shadow] md:duration-300 md:ease-[cubic-bezier(0.22,1,0.36,1)]",
