  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new AVS Code prerelease is available for nightly testers."
          : "A new AVS Code latest release is available.",
...
).pipe(Command.withDescription("Post a AVS Code release announcement to Discord."));
